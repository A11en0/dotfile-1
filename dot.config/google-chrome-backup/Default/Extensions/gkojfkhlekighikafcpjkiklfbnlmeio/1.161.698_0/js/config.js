...
const get_paths = ()=>{
    ...
    const f = {
        local: {
            ...
            '/bext/vpn/ui/locale.js': 'BASE/bext/vpn/ui/locale.js',
...
var perr = opt=>{
    if (window.be_bg_main && window.be_bg_main.be_util &&
        window.be_bg_main.be_util.perr)
    {
	return window.be_bg_main.be_util.perr(opt.id, opt.info,
            {err: opt.err});
    }
