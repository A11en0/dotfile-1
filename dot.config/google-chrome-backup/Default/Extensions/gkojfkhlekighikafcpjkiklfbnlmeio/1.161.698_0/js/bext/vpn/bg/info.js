// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/ext.js', '/bext/pub/util.js', '/util/util.js', '/util/zerr.js', '/util/date.js', '/bext/vpn/bg/bg_ajax.js', '/util/storage.js', '/bext/vpn/bg/svc.js', '/bext/vpn/util/util.js', '/svc/hola/pub/svc_ipc.js', '/util/url.js', 'conf'], function (exports, _underscore, _backbone, _etask, _ext, _util, _util3, _zerr, _date, _bg_ajax, _storage, _svc, _util5, _svc_ipc, _url, _conf) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _ext2 = _interopRequireDefault(_ext);var _util2 = _interopRequireDefault(_util);var _util4 = _interopRequireDefault(_util3);var _zerr2 = _interopRequireDefault(_zerr);var _date2 = _interopRequireDefault(_date);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _storage2 = _interopRequireDefault(_storage);var _svc2 = _interopRequireDefault(_svc);var _util6 = _interopRequireDefault(_util5);var _svc_ipc2 = _interopRequireDefault(_svc_ipc);var _url2 = _interopRequireDefault(_url);var _conf2 = _interopRequireDefault(_conf);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        E.init = () => {
            if (E.get('inited'))
            return;
            _util2.default.set_perr_cb(perr_res_cb);
            E.set('inited', true);
        ...
        const perr_res_cb = res => {
            if (res && res.ip && res.country)
            set_location(res);
        };

        const set_location = ({ ip, country }) => {
            const location = E.get('location');
            if (location && location.ip == ip && location.country == country)
            return;
            E.set('location', { ip, country });
            _storage2.default.set_json('location', { ip, country });
        };
        ...
        E.get_unblocking_rate = (limit, src_country) => {
            ...
            function* get_unblocking_rate_() {
                ...
                _util2.default.perr('be_unblocking_rate_err', {}, { err });
            });
        };
        ...
        E.efetch_info = () => {
            return (0, _etask2.default)({ name: 'efetch_info', cancel: true }, function* efetch_info_() {
                try {
                    ...
                    const info = yield _bg_ajax2.default.ccgi_ajax({ qs: _ext2.default.auth(),
                        url: _conf2.default.url_ccgi + '/fetch_info', retry: 1 });
                    set_location(info.req);
                } catch (err) {
                    _util2.default.perr('be_info_fetch_info_err', {}, { err });
                    throw err;
                }
            });
        };
        ...
        E.on('fetch_info', () => {
            ...
            return E.sp.spawn((0, _etask2.default)({ name: 'fetch_info', cancel: true }, function* () {
                try {
                    ...
                    E.set_err();
                    _util2.default.perr('be_info_on_fetch_info_err', {}, { err });
                }
            }));
        });
        ...
        E.on('set_user_id', () => {
            ...
            return (0, _etask2.default)('set_user_id', function* set_user_id_() {
                ...
                } catch (err) {_util2.default.perr('be_info_set_user_id_err', {}, { err });}
            });
        });
        ...
        E.set_dont_show_again = opt => {
            ...
            _util2.default.perr('be_set_dont_show_again', opt);
        };
        ...
        E.resend_verification_email = () => _bg_ajax2.default.hola_api_call(
        'users/send_email_verification', { method: 'POST' });
