// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/ext.js', '/bext/pub/util.js', '/util/zerr.js', '/bext/vpn/bg/rule.js', '/bext/vpn/bg/tabs.js', '/bext/pub/browser.js', '/bext/vpn/util/util.js', '/bext/vpn/bg/vpn.js', '/bext/vpn/bg/svc.js', '/bext/vpn/bg/util.js'], function (exports, _underscore, _backbone, _etask, _ext, _util, _zerr, _rule, _tabs, _browser, _util3, _vpn, _svc, _util5) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _ext2 = _interopRequireDefault(_ext);var _util2 = _interopRequireDefault(_util);var _zerr2 = _interopRequireDefault(_zerr);var _rule2 = _interopRequireDefault(_rule);var _tabs2 = _interopRequireDefault(_tabs);var _browser2 = _interopRequireDefault(_browser);var _util4 = _interopRequireDefault(_util3);var _vpn2 = _interopRequireDefault(_vpn);var _svc2 = _interopRequireDefault(_svc);var _util6 = _interopRequireDefault(_util5);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        function set_icon_cb(retry) {
            return function () {
                ...
                _util2.default.perr('set_icon_err', { retry }, { rate_limit: { count: 1 }, err });
            };
        }
        ...
        function refresh(tab, retry) {
            ...
            if (!_ext2.default.get('enabled') || !rule || !rule.enabled || !rule.country)
            {
                ...
                {
                    _util2.default.perr('icon_no_country_err', { url: url,
        ...
        function on_refresh(o) {
            ...
            E.sp.spawn({ name: 'refresh', cancel: true }, (0, _etask2.default)(function* on_r_() {
                ...
                } catch (e) {_util2.default.perr('be_icon_refresh_err', {}, { err: e });}
            }));
        }exports.default =
        E;});})();
