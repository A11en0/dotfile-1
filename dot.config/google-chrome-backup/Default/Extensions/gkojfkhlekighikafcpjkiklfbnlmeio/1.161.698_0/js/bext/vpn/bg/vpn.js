// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/ext.js', '/util/util.js', '/util/array.js', '/bext/pub/util.js', '/util/zerr.js', '/bext/vpn/bg/rule.js', '/bext/vpn/bg/info.js', '/bext/vpn/bg/tabs.js', '/svc/vpn/pub/util.js', '/util/version_util.js', '/bext/vpn/bg/tpopup.js', '/util/url.js', '/bext/vpn/bg/tab_unblocker.js', '/bext/vpn/bg/bg_ajax.js', '/util/storage.js', '/bext/vpn/util/util.js', '/util/date.js', '/bext/vpn/bg/svc.js', '/bext/vpn/bg/pac.js', '/bext/vpn/bg/mode.js', '/bext/vpn/bg/tab_perr.js', '/bext/vpn/bg/premium.js', '/svc/vpn/pub/unblocker_lib.js', '/bext/vpn/bg/force_lib.js', '/protocol/pub/countries.js', '/bext/vpn/bg/trial.js', '/bext/vpn/bg/mitm_lib.js', '/bext/vpn/bg/util.js', '/bext/vpn/bg/dev_mode.js', 'conf'], function (exports, _underscore, _backbone, _etask, _ext, _util, _array, _util3, _zerr, _rule, _info, _tabs, _util5, _version_util, _tpopup, _url, _tab_unblocker, _bg_ajax, _storage, _util7, _date, _svc, _pac, _mode, _tab_perr, _premium, _unblocker_lib, _force_lib, _countries, _trial, _mitm_lib, _util9, _dev_mode, _conf2) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _ext2 = _interopRequireDefault(_ext);var _util2 = _interopRequireDefault(_util);var _array2 = _interopRequireDefault(_array);var _util4 = _interopRequireDefault(_util3);var _zerr2 = _interopRequireDefault(_zerr);var _rule2 = _interopRequireDefault(_rule);var _info2 = _interopRequireDefault(_info);var _tabs2 = _interopRequireDefault(_tabs);var _util6 = _interopRequireDefault(_util5);var _version_util2 = _interopRequireDefault(_version_util);var _tpopup2 = _interopRequireDefault(_tpopup);var _url2 = _interopRequireDefault(_url);var _tab_unblocker2 = _interopRequireDefault(_tab_unblocker);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _storage2 = _interopRequireDefault(_storage);var _util8 = _interopRequireDefault(_util7);var _date2 = _interopRequireDefault(_date);var _svc2 = _interopRequireDefault(_svc);var _pac2 = _interopRequireDefault(_pac);var _mode2 = _interopRequireDefault(_mode);var _tab_perr2 = _interopRequireDefault(_tab_perr);var _premium2 = _interopRequireDefault(_premium);var _unblocker_lib2 = _interopRequireDefault(_unblocker_lib);var _force_lib2 = _interopRequireDefault(_force_lib);var _countries2 = _interopRequireDefault(_countries);var _trial2 = _interopRequireDefault(_trial);var _mitm_lib2 = _interopRequireDefault(_mitm_lib);var _util10 = _interopRequireDefault(_util9);var _dev_mode2 = _interopRequireDefault(_dev_mode);var _conf3 = _interopRequireDefault(_conf2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        function clean_cookies(domain) {
            ...
            E.sp.spawn((0, _etask2.default)(function* clean_cookies_all_() {
                ...
                if (filtered.length)
                {
                    _util4.default.perr('be_clean_cookies2', { rule: domain,
                        cookies: filtered.map(c => _underscore2.default.pick(c, 'domain', 'name', 'path')) },
                    { rate_limit: { count: 1 } });
                }
            }));
        }
        ...
        const convert_rules_storage = () => (0, _etask2.default)(function* _convert_rules_storage() {
            ...
            storage_converted = 2;
            if (rules.stamp)
            _util4.default.perr('be_storage_converted');
        });
        ...
        const init_unblocker_lib = () => (0, _etask2.default)(function* _init_unblocker_lib() {
            ...
            yield _unblocker_lib2.default.init({
                perr: (opt, err) => err ?
                _util4.default.perr(opt.id, opt.info, assign({ err }, opt)) :
                _util4.default.perr(opt.id, opt.info, opt),
                ...
                '/verify_proxy',
                force_agent: () => _dev_mode2.default.get('force_agent'),
        ...
        proxy_settings_monitor.changed_cb = function (details) {
            ...
            if (!!prev == !!conflict)
            return;
            _util4.default.perr(conflict ? 'ext_conflict' : 'ext_conflict_resolved', {
        ...
        E.init = function () {return (0, _etask2.default)(function* init() {
                ...
                _util4.default.perr('be_bump_done', { bump: _storage2.default.get_int('bump'),
                    ms: Date.now() - bump_ts });
            });};
                ...
                for (let n = 1;; n++)
                {
                    if (n >= 60)
                    {
                        ...
                        if (ts_in_range(begin_ts, active_ts_ar, end_ts))
                        {
                            ...
                            begin_ts, end_ts);
                            _util4.default.perr('be_active', assign({ agents,
        ...
        function check_bump(bext_config) {
            ...
            E.listen_to(_tab_unblocker2.default, 'change:activity', _underscore2.default.debounce(function () {
                ...
                _util4.default.perr('be_reload_ext_bump');
        ...
        function bext_config_init() {
            ...
            [function try_catch$loop() {
                ...
                if (err || !e)
                {
                    ...
                    _util4.default.perr('be_bext_config_err', { n: config_stats.n,
                        after_err: config_stats.err, status: err_info.status,
                        exists: !!_ext2.default.get('bext_config'),
                        attempt: config_stats.attempt, stamp: CG('stamp') }, { err });
                    pause = 5 * _date2.default.ms.MIN;
                } else
                if (e && e.stamp && CG('stamp', 0) > e.stamp)
                {
                    _util4.default.perr('be_bext_config_old', { n: config_stats.n,
                        after_err: config_stats.err, attempt: config_stats.attempt });
                } else

                {
                    _util4.default.perr('be_bext_config_success', { n: config_stats.n,
                        after_err: config_stats.err, attempt: config_stats.attempt });
                    E.set_bext_config(e);
                    check_bump(e);
        ...
        const update_vpn_countries = () => (0, _etask2.default)(function* _update_vpn_countries() {
            ...
            const retry = e => (0, _etask2.default)(function* _retry() {
                _util4.default.perr('be_vpn_countries_err', { retries }, { err: e });
        ...
        E.reverify = rule => {
            ...
            _unblocker_lib2.default.reverify(rule);
        };
        ...
        function total_active_report(tab) {
            ...
            if (rule = tab.rule)
            {
                ...
                _util4.default.perr('be_vpn_total_active_time', JSON.stringify(
                assign(stats, { root_url: tab.root_url, src_country: loc_country,
                    total_active_time: tab.active_time / 1000,
                    first_per_time: first_per_time })), { rate_limit: { count: 20 } });
                if (first_per_time)
            ...
            return;
            _util4.default.perr('be_total_active_time', JSON.stringify(
            { root_url: tab.root_url, src_country: loc_country,
                total_active_time: tab.active_time / 1000 }), { rate_limit: { count: 20 } });
        }
        ...
        function tab_vpn_on_error_occured(o) {
            ...
            _util4.default.perr('be_dns_mistake', perr_info, { err: true,
                rate_limit: { count: 5 } });
        }
        ...
        E.set_enabled = function (on) {
            try {
                ...
                if (!!_ext2.default.get('ext.active') != on && !_ext2.default.get('ext.conflict'))
                {
                    ...
                    _util4.default.perr('be_set_enabled_mismatch', { on, attributes },
                    { err: true, rate_limit: { count: 1 } });
                }
            } catch (e) {
                _util4.default.perr('be_set_enabled_err', {}, { err: e });
                throw e;
            }
        };
        ...
        E.enable_root_url = opt => (0, _etask2.default)({ cancel: true }, function* enable_root_url() {
...

            {
                if (opt.rule)
                {
                    _util4.default.perr('be_enable_root_url_invalid_rule',
                    assign(opt, { hola_uid: _ext2.default.get('hola_uid') }));
                }
            ...
            _util4.default.perr('be_enable_root_url', { name: rule.name, root_url,
                country: rule.country, hola_uid: _ext2.default.get('hola_uid'),
        ...
        E.check_permission = name => {
            ...
            function* check_permission() {
                try {
                    ...
                    _util4.default.perr('check_permission_failed', {}, { err: e });
                }
            });
        };
        ...
        E.grant_permission = function (name) {
            ...
            function* grant_permission() {
                try {
                    ...
                    _util4.default.perr('grant_permission_failed', {}, { err: e });
                }
            });
        };
        ...
        E.set_enabled_for_pc = (enable, opt) => {
            ...
            if (!E.get('protect_pc'))
            return;
            _util4.default.perr('be_ui_vpn_protect_pc', { enable });
        ...
        E.set_enabled_for_browser = function (enable, opt) {
            ...
            if (!E.get('protect_browser'))
            return;
            _util4.default.perr('be_ui_vpn_protect_browser', { enable });
            let rule;
            if (!enable)
            {
                if (E.is_enabled_for_pc())
        ...
        E.reset_busy = () => {
            ...
            _util4.default.perr('reset_busy', res, { rate_limit: { count: 3 } });
        };
