// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'conf', '/bext/pub/backbone.js', '/util/etask.js', '/util/zerr.js', '/util/date.js', '/bext/pub/ext.js', '/bext/vpn/bg/bg_ajax.js', '/bext/vpn/bg/tabs.js', '/bext/pub/util.js', '/bext/vpn/bg/premium.js', '/util/util.js', '/bext/vpn/util/util.js'], function (exports, _conf, _backbone, _etask, _zerr, _date, _ext, _bg_ajax, _tabs, _util, _premium, _util3, _util5) {Object.defineProperty(exports, "__esModule", { value: true });var _conf2 = _interopRequireDefault(_conf);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _zerr2 = _interopRequireDefault(_zerr);var _date2 = _interopRequireDefault(_date);var _ext2 = _interopRequireDefault(_ext);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _tabs2 = _interopRequireDefault(_tabs);var _util2 = _interopRequireDefault(_util);var _premium2 = _interopRequireDefault(_premium);var _util4 = _interopRequireDefault(_util3);var _util6 = _interopRequireDefault(_util5);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        Trial.prototype.set_trial = function (root_url, cmd, opt) {
            ...
            return (0, _etask2.default)('trial_start', function* trial_start_() {
                try {
                    ...
                    _util2.default.perr('be_trial_start', { root_url, cmd });
                    let res = yield _bg_ajax2.default.ccgi_ajax(
                    { url: _conf2.default.url_ccgi + '/trial_set2', qs });
                    if (!_util4.default.get(res, 'time_left'))
                    {
                        _util2.default.perr('be_trial_start_no_trial', { root_url, cmd });
                        return;
                    }
                    _util2.default.perr('be_trial_start_got_trial', { cmd, root_url,
                        time_left: res.time_left, grace_ms: res.grace_ms });
                    ...
                    _util2.default.perr('be_trial_start_error', { root_url, cmd },
        ...
        Trial.prototype.set_time_left = function (root_url, value, reset_use) {
            ...
            return (0, _etask2.default)('trial_set_time_left', function* set_time_left_() {
                try {
                    _util2.default.perr('set_time_left', { root_url, value });
        ...
        Trial.prototype.reset = function (root_url) {
            ...
            return (0, _etask2.default)(function* trial_reset() {
                try {
                    _util2.default.perr('set_time_left_', { root_url });
        ...
        function monitor_active_trial(on_active_cb) {
            ...
            return _etask2.default.interval(_date2.default.ms.SEC, function* monitor_active_trial_() {
                ...
                {
                    if (trial_usage > 0)
                    _util2.default.perr('be_site_trial_usage', { sec: trial_usage });
                    trial_usage = 0;
                    if (!is_grace)
        ...
        function get_trials(url) {
            ...
            return (0, _etask2.default)('get_trials', function* get_trials_() {
                try {
                    ...
                    {
                        _util2.default.perr('be_empty_user_session');
                        return;
                    }
