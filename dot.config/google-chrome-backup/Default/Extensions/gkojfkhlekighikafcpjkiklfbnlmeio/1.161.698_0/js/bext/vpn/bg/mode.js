// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', '/bext/pub/backbone.js', '/util/zerr.js', '/bext/vpn/bg/svc.js', '/bext/pub/util.js', '/util/storage.js', '/util/date.js'], function (exports, _backbone, _zerr, _svc, _util, _storage, _date) {Object.defineProperty(exports, "__esModule", { value: true });var _backbone2 = _interopRequireDefault(_backbone);var _zerr2 = _interopRequireDefault(_zerr);var _svc2 = _interopRequireDefault(_svc);var _util2 = _interopRequireDefault(_util);var _storage2 = _interopRequireDefault(_storage);var _date2 = _interopRequireDefault(_date);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        function update_mode() {
            ...
            _util2.default.perr('mode_change', {
                new_mode: new_mode,
