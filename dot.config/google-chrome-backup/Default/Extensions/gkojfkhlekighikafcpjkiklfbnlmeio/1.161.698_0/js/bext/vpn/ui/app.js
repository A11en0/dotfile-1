// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', 'react', 'react-dom', 'react-flip-toolkit', '/util/zerr.js', '/util/util.js', '/util/storage.js', '/bext/vpn/ui/debug_ui.js', '/bext/pub/util.js', '/bext/vpn/util/util.js', '/bext/vpn/ui/ui_lib.js', '/bext/vpn/ui/ui_react.js', '/bext/vpn/ui/watermark.js', '/bext/vpn/ui/ui_api.js', '/bext/vpn/ui/context.js'], function (exports, _underscore, _react, _reactDom, _reactFlipToolkit, _zerr, _util, _storage, _debug_ui, _util3, _util5, _ui_lib, _ui_react, _watermark, _ui_api, _context) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _react2 = _interopRequireDefault(_react);var _reactDom2 = _interopRequireDefault(_reactDom);var _zerr2 = _interopRequireDefault(_zerr);var _util2 = _interopRequireDefault(_util);var _storage2 = _interopRequireDefault(_storage);var _debug_ui2 = _interopRequireDefault(_debug_ui);var _util4 = _interopRequireDefault(_util3);var _util6 = _interopRequireDefault(_util5);var _ui_lib2 = _interopRequireDefault(_ui_lib);var _ui_react2 = _interopRequireDefault(_ui_react);var _watermark2 = _interopRequireDefault(_watermark);var _ui_api2 = _interopRequireDefault(_ui_api);var _context2 = _interopRequireDefault(_context);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
        ...
        Error_boundary = class Error_boundary extends _react2.default.Component {constructor(...args) {var _temp;return _temp = super(...args), this.
            ...
            componentDidCatch(err, info) {
                ...
                _ui_api2.default.perr('be_ui_vpn_render_err', info, { err });
        ...
        const App = () => {
            ...
            _react2.default.createElement(_debug_ui2.default.Debug_ui, null),
        ...
        const schedule_auto_reload = () => {
            if (_util6.default.is_tpopup())
            {
                _ui_api2.default.perr('be_popup_reload_ext_skip', {},
        ...
        const send_render_stats = () => {
            ...
            'popup_render', { url: _ui_api2.default.get_url() });
        };
        ...
        E.pre_init = () => {
            init_slow_timer = _util6.default.set_timeout(() => {
                _ui_api2.default.perr('be_ui_popup_slow_render');
        ...
        E.render_init_err = () => {
            ...
            _ui_api2.default.perr('be_ui_obj_init_err', init_err_info(),
        ...
        E.init = () => {
            try {
                ...
                _ui_api2.default.perr('be_ui_app_init_err', {}, { err: e });
                E.render_init_err(e);
            }
            send_render_stats();
        };
