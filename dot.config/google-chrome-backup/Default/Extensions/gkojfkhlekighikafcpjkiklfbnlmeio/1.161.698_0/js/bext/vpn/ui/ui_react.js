// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'react', 'react-dom', 'classnames', 'react-flip-toolkit', '/util/util.js', '/util/etask.js', '/util/url.js', '/util/string.js', '/util/country.js', 'react-tiny-virtual-list', '/bext/vpn/ui/debug_ui.js', '/bext/vpn/ui/ui_lib.js', '/bext/vpn/ui/ui_api.js', '/bext/vpn/util/util.js', '/svc/vpn/pub/util.js', '/svc/vpn/pub/common_ui.js', '/bext/pub/util.js', '/bext/vpn/ui/privacy.js', '/bext/vpn/ui/context.js'], function (exports, _react, _reactDom, _classnames, _reactFlipToolkit, _util, _etask, _url, _string, _country, _reactTinyVirtualList, _debug_ui, _ui_lib, _ui_api, _util3, _util5, _common_ui, _util7, _privacy, _context) {Object.defineProperty(exports, "__esModule", { value: true });var _react2 = _interopRequireDefault(_react);var _reactDom2 = _interopRequireDefault(_reactDom);var _classnames2 = _interopRequireDefault(_classnames);var _util2 = _interopRequireDefault(_util);var _etask2 = _interopRequireDefault(_etask);var _url2 = _interopRequireDefault(_url);var _string2 = _interopRequireDefault(_string);var _country2 = _interopRequireDefault(_country);var _reactTinyVirtualList2 = _interopRequireDefault(_reactTinyVirtualList);var _debug_ui2 = _interopRequireDefault(_debug_ui);var _ui_lib2 = _interopRequireDefault(_ui_lib);var _ui_api2 = _interopRequireDefault(_ui_api);var _util4 = _interopRequireDefault(_util3);var _util6 = _interopRequireDefault(_util5);var _common_ui2 = _interopRequireDefault(_common_ui);var _util8 = _interopRequireDefault(_util7);var _privacy2 = _interopRequireDefault(_privacy);var _context2 = _interopRequireDefault(_context);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};
        ...
        const General_menu = memo(function General_menu(props) {
            ...
            _react2.default.createElement('a', { onClick: props.on_debug }, _react2.default.createElement(T, null, 'Debug'))),
        ...
        const Conflict_msg = memo(function Conflict_msg(props) {
            useEffect(() => void perr('be_render_ext_conflict'));
        ...
        E.Vpn_ui = memo(function Vpn_ui(props) {
            ...
            const [show_debug_view, toggle_debug_view] = useState(false);
            ...
            is_menu_open && _react2.default.createElement(Menu, { on_incognito: on_incognito,
                toggle_menu: toggle_menu, on_debug: on_debug }),
            show_incognito_modal && _react2.default.createElement(Incognito_modal, {
                on_close: () => toggle_incognito_modal(false) }),
            show_debug_view && dev_mode && _react2.default.createElement(_debug_ui2.default.Debug_view, {
                on_close: () => toggle_debug_view(false) })));
