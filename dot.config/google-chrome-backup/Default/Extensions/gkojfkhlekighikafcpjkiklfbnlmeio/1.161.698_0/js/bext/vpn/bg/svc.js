// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/util.js', '/bext/pub/ext.js', '/util/util.js', 'underscore', '/util/date.js', '/util/zerr.js', '/svc/hola/pub/svc_ipc.js', '/svc/hola/pub/svc_monitor.js', '/util/escape.js', '/bext/vpn/bg/bg_ajax.js', 'conf'], function (exports, _backbone, _etask, _util, _ext, _util3, _underscore, _date, _zerr, _svc_ipc, _svc_monitor, _escape, _bg_ajax, _conf) {Object.defineProperty(exports, "__esModule", { value: true });var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _util2 = _interopRequireDefault(_util);var _ext2 = _interopRequireDefault(_ext);var _util4 = _interopRequireDefault(_util3);var _underscore2 = _interopRequireDefault(_underscore);var _date2 = _interopRequireDefault(_date);var _zerr2 = _interopRequireDefault(_zerr);var _svc_ipc2 = _interopRequireDefault(_svc_ipc);var _svc_monitor2 = _interopRequireDefault(_svc_monitor);var _escape2 = _interopRequireDefault(_escape);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _conf2 = _interopRequireDefault(_conf);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        E.init = be_vpn => {
            ...
            E.listenTo(_ext2.default, 'change:bext_config', () => {
                ...
                let use_new_monitor = _util4.default.get(bext_config, 'svc.use_new_monitor');
            ...
            EE.watch_vpn_status = () => {
                ...
                function* watch_vpn_status_loop_()
                {
                    ...
                    while (true)
                    {
                        ...
                        status = _util4.default.get(status, 'ret') || {};
        ...
        E.svc_mon_new = (EE => {
            EE.init = () => {
                ...
                _svc_monitor2.default.init({
                    ...
                    perr: (id, info) => _util2.default.perr(id, info),
        ...
        const ensure_vpn_info = () => {
            return (0, _etask2.default)({ name: 'ensure_vpn_info' }, [function try_catch$() {
                ...
                if (this.error || !info)
                {
                    return void _util2.default.perr('ensure_vpn_info_fail', {},
                    { err: this.error });
                }
                var vpn_info = _util4.default.pick(info, 'login', 'password');
        ...
        E.vpn_connect = opt => (0, _etask2.default)(function* vpn_connect_() {
            try {
                ...
                set_status('ready', '');
                _util2.default.perr('vpn_connect', {}, { err: e });
            }
        });
        ...
        E.vpn_disconnect = () => (0, _etask2.default)(function* vpn_disconnect_() {
            ...
            try {
                ...
                _util2.default.perr('vpn_disconnect', {}, { err: e });
            }
        });
        ...
        E.vpn_change_agent = () => (0, _etask2.default)(function* vpn_change_agent_() {
            ...
            try {
                ...
                _util2.default.perr('vpn_change_agent', {}, { err: e });
            }
        });
