// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/util/zerr.js', '/bext/pub/util.js', '/bext/vpn/bg/util.js', '/bext/vpn/bg/svc.js', '/bext/vpn/bg/mode.js', '/util/storage.js', '/bext/vpn/bg/rule.js', '/bext/vpn/bg/vpn.js', '/bext/vpn/bg/tabs.js', '/bext/vpn/bg/info.js', '/bext/vpn/bg/premium.js', '/bext/vpn/util/util.js', 'zon_config', 'conf'], function (exports, _underscore, _backbone, _etask, _zerr, _util, _util3, _svc, _mode, _storage, _rule, _vpn, _tabs, _info, _premium, _util5, _zon_config, _conf) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _zerr2 = _interopRequireDefault(_zerr);var _util2 = _interopRequireDefault(_util);var _util4 = _interopRequireDefault(_util3);var _svc2 = _interopRequireDefault(_svc);var _mode2 = _interopRequireDefault(_mode);var _storage2 = _interopRequireDefault(_storage);var _rule2 = _interopRequireDefault(_rule);var _vpn2 = _interopRequireDefault(_vpn);var _tabs2 = _interopRequireDefault(_tabs);var _info2 = _interopRequireDefault(_info);var _premium2 = _interopRequireDefault(_premium);var _util6 = _interopRequireDefault(_util5);var _zon_config2 = _interopRequireDefault(_zon_config);var _conf2 = _interopRequireDefault(_conf);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        function send_msg(msg, resp_cb) {
            try {return resp_cb(msg);}
                ...
                _util2.default.perr('be_ccgi_send_err', msg.id, { err: e,
        ...
        function ccgi_ipc_handler(msg, sender, resp_cb) {
            ...
            switch (msg.id) {
                ...
                case 'vpn_enable': 
                    ...
                    return true;
                case 'perr':
                    _util2.default.perr(msg.perr_id, JSON.parse(msg.info));
                    break;
                case 'set_rule':
                    msg.data = {};
