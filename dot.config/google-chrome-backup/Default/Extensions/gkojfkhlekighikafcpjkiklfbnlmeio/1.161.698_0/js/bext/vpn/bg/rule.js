...
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/ext.js', '/bext/pub/util.js', '/util/zerr.js', '/bext/vpn/util/util.js', '/bext/vpn/bg/tab_unblocker.js', '/util/url.js', '/util/escape.js', '/bext/vpn/bg/bg_ajax.js', '/util/array.js', '/svc/vpn/pub/util.js', '/svc/vpn/pub/unblocker_lib.js', '/bext/vpn/bg/mode.js', '/bext/vpn/bg/tabs.js', '/util/date.js', '/util/util.js', '/bext/vpn/bg/info.js', '/bext/vpn/bg/trial.js', '/util/rate_limit.js', '/util/ajax.js', 'conf', '/bext/vpn/bg/premium.js'], function (exports, _underscore, _backbone, _etask, _ext, _util, _zerr, _util3, _tab_unblocker, _url, _escape, _bg_ajax, _array, _util5, _unblocker_lib, _mode, _tabs, _date, _util7, _info, _trial, _rate_limit, _ajax, _conf, _premium) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _ext2 = _interopRequireDefault(_ext);var _util2 = _interopRequireDefault(_util);var _zerr2 = _interopRequireDefault(_zerr);var _util4 = _interopRequireDefault(_util3);var _tab_unblocker2 = _interopRequireDefault(_tab_unblocker);var _url2 = _interopRequireDefault(_url);var _escape2 = _interopRequireDefault(_escape);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _array2 = _interopRequireDefault(_array);var _util6 = _interopRequireDefault(_util5);var _unblocker_lib2 = _interopRequireDefault(_unblocker_lib);var _mode2 = _interopRequireDefault(_mode);var _tabs2 = _interopRequireDefault(_tabs);var _date2 = _interopRequireDefault(_date);var _util8 = _interopRequireDefault(_util7);var _info2 = _interopRequireDefault(_info);var _trial2 = _interopRequireDefault(_trial);var _rate_limit2 = _interopRequireDefault(_rate_limit);var _ajax2 = _interopRequireDefault(_ajax);var _conf2 = _interopRequireDefault(_conf);var _premium2 = _interopRequireDefault(_premium);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        function* _on_max_redirects() {
            ...
            if (!update)
            return;
            _util2.default.perr('max_redirect_rule_disable', { from, to, urls },
            { rate_limit: { count: 1 } });
        ...
        E.get_rule_ratings = args => _bg_ajax2.default.ccgi_ajax({ slow: 2 * SEC,
            ...
            perr: opt => _util2.default.perr(opt.id, opt.info, opt) });
        ...
        function fetch_rules() {
            ...
            E.sp.spawn((0, _etask2.default)({ cancel: true }, function* fetch_rules_() {
                ...
                try {yield E.update_rules();
                    ...
                    E.set_err();
                    _util2.default.perr('be_script_fetch_rules_err', {}, { err: e });
                }
            }));
        }
            ...
            E.sp.spawn((0, _etask2.default)({ cancel: true }, function* _set_rule() {
                ...
                try {
                    ...
                    if (!opt.stub)
                    {
                        ...
                        _util2.default.perr('be_set_rule_mismatch', { opt, r, hola_uid });
                        if (opt.enabled)
                        {
                    ...
                    _util2.default.perr('be_set_rule_ok', { name: opt.name, type: opt.type,
                        country: opt.country, enabled: opt.enabled, hola_uid });
                } catch (e) {
                    set_tab_state(tab_id, 'set_rule_err');
                    E.set_err();
                    _util2.default.perr('be_script_set_rule_err', { hola_uid }, { err: e });
                }
            }));
        }
        ...
        E.verify_proxy = opt => {
            ...
            return (0, _etask2.default)({ cancel: true }, function* verify_proxy_() {
                ...
                E.task_insert(this);
                _unblocker_lib2.default.reverify(opt.rule);
        ...
        E.send_fix_it_report = opt => (0, _etask2.default)(function* send_fix_it_report_() {
            ...
            const res = yield _util2.default.perr('be_ui_vpn_click_no_fix_it', info,
            { err: true, filehead: log });
        ...
        E.send_vpn_work_report = function (opt) {
            ...
            _util2.default.perr('be_vpn_ok', assign({
        ...
        E.fix_vpn = opt => {
            ...
            function* fix_vpn_() {
                ...
                try {
                    ...
                    this.fix_waiting = false;
                    _util2.default.perr('be_fix_vpn_err', opt, { err: e });
                }
            });
        };
        ...
        E._set_req_err = (id, agent, opt) => (0, _etask2.default)(function* _set_req_err_() {
            ...
            try {
                ...
                _util2.default.perr(id + '_set_err_failed', {}, { rate_limit: { count: 1 },
                    err: e });
                return { err: e };
            }
        });
        ...
        E.change_proxy = (details, reason, route_opt) => {
            ...
            if (!exclude.length)
            {
                ...
                _util2.default.perr('debug_null_agents', { agents:
                    _unblocker_lib2.default.get_active_agents(tu.rule), details }, { err: true });
            }
            exclude = exclude.map(e => _util8.default.omit(e, 'rtt'));
            const bad_agents = _underscore2.default.pluck(exclude, 'host');
            _util2.default.perr('change_proxy_on_err', { reason, bad_agents });
        ...
        function check_retry(rule, agent, details, tab, route_opt) {
            ...
            var retry = reason => {
                ...
                url.slice(0, 200));
                _util2.default.perr('req_err_retry_' + reason, { url,
        ...
        E.fix_req_err = (rule, agent, d, tab, route_opt) => {
            ...
            if (tab.req_err_n == limit)
            {
                _util2.default.perr('req_err_autoreload_max', info);
                if (is_main_frame(d) && request_errors.includes(d.error))
                {
                    _util2.default.perr('req_err_main_frame', info);
                }
            }
            _util2.default.perr('req_err', info);
        ...
        E.fix_media_req_err = (rule, agent, d, tab, route_opt, opt) => {
            ...
            if (!opt.disable_perr)
            {
                _util2.default.perr('media_failure_detected', { url: d.url, code: d.statusCode,
                    page_url: tab_url, root_url, agent: host, set_err: !!set_err,
