// disabling `no-unused-vars` rule as these methods are declared here but used in `background.js`
 ...
 * @description  it returns set of key/value pairs representing form fields and their values,
