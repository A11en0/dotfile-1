...
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/util.js', '/bext/vpn/bg/util.js', '/util/zerr.js', '/bext/pub/browser.js', '/util/escape.js', '/util/version_util.js', '/util/storage.js', '/util/ajax.js', '/util/util.js', '/util/date.js', '/bext/pub/ga.js', '/bext/vpn/bg/tabs.js', '/bext/vpn/bg/bg_ajax.js', '/bext/vpn/bg/icon.js', '/bext/pub/ext.js', '/bext/vpn/bg/rule.js', '/bext/vpn/bg/premium.js', '/bext/vpn/bg/dev_mode.js', '/bext/vpn/bg/trial.js', '/bext/vpn/bg/ccgi.js', '/bext/vpn/bg/vpn.js', '/svc/vpn/pub/unblocker_lib.js', '/bext/vpn/bg/info.js', '/bext/vpn/util/util.js', '/bext/vpn/bg/mode.js', '/bext/vpn/bg/tpopup.js', 'conf', '/bext/vpn/bg/bext_config.js', '/bext/vpn/bg/tab_unblocker.js', '/svc/vpn/pub/util.js', 'cookie', '/bext/vpn/bg/ui_api.js', '/bext/vpn/bg/pac_engine.js'], function (exports, _underscore, _backbone, _etask, _util, _util3, _zerr, _browser, _escape, _version_util, _storage, _ajax, _util5, _date, _ga, _tabs, _bg_ajax, _icon, _ext, _rule, _premium, _dev_mode, _trial, _ccgi, _vpn, _unblocker_lib, _info, _util7, _mode, _tpopup, _conf, _bext_config, _tab_unblocker, _util9, _cookie, _ui_api, _pac_engine) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _util2 = _interopRequireDefault(_util);var _util4 = _interopRequireDefault(_util3);var _zerr2 = _interopRequireDefault(_zerr);var _browser2 = _interopRequireDefault(_browser);var _escape2 = _interopRequireDefault(_escape);var _version_util2 = _interopRequireDefault(_version_util);var _storage2 = _interopRequireDefault(_storage);var _ajax2 = _interopRequireDefault(_ajax);var _util6 = _interopRequireDefault(_util5);var _date2 = _interopRequireDefault(_date);var _ga2 = _interopRequireDefault(_ga);var _tabs2 = _interopRequireDefault(_tabs);var _bg_ajax2 = _interopRequireDefault(_bg_ajax);var _icon2 = _interopRequireDefault(_icon);var _ext2 = _interopRequireDefault(_ext);var _rule2 = _interopRequireDefault(_rule);var _premium2 = _interopRequireDefault(_premium);var _dev_mode2 = _interopRequireDefault(_dev_mode);var _trial2 = _interopRequireDefault(_trial);var _ccgi2 = _interopRequireDefault(_ccgi);var _vpn2 = _interopRequireDefault(_vpn);var _unblocker_lib2 = _interopRequireDefault(_unblocker_lib);var _info2 = _interopRequireDefault(_info);var _util8 = _interopRequireDefault(_util7);var _mode2 = _interopRequireDefault(_mode);var _tpopup2 = _interopRequireDefault(_tpopup);var _conf2 = _interopRequireDefault(_conf);var _bext_config2 = _interopRequireDefault(_bext_config);var _tab_unblocker2 = _interopRequireDefault(_tab_unblocker);var _util10 = _interopRequireDefault(_util9);var _cookie2 = _interopRequireDefault(_cookie);var _ui_api2 = _interopRequireDefault(_ui_api);var _pac_engine2 = _interopRequireDefault(_pac_engine);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        _zerr2.default.set_exception_handler('be', (id, info, err) =>
        _util2.default.perr(id, info, { err }));
        _zerr2.default.on_unhandled_exception = function (err) {
            (0, _zerr2.default)('unhandled_exception %s', err && err.stack);
            _util2.default.perr('unhandled_exception', {}, { err, rate_limit: { count: 2 } });
        };
        ...
        const send_install_perr = () => (0, _etask2.default)(function* _send_install_perr() {
            ...
            if (be_usage)
            {
                ...
                } catch (err) {_util2.default.perr('be_usage_parse_err', {}, { err });}
            }
            _util2.default.perr('install', info);
        ...
        function on_update(prev) {
            _util2.default.perr('update', prev + ' > ' + _util2.default.version());
            _storage2.default.set('update_ts', window.hola.t.l_start);
        }
        function on_up() {_util2.default.perr('up');}
        ...
        function get_uuid() {
            return (0, _etask2.default)({ name: 'get_uuid', cancel: true }, function* () {
                try {
                    ...
                    {
                        reused_uuid = true;
                        _util2.default.perr('uuid_storage_mismatch', { uuid, ret });
                    }
                    return uuid;
                } catch (err) {
                    _util2.default.perr('unreachable', 'get_uuid', { err });
                }
            });
        }
        ...
        function persist_uuid(uuid) {
            return (0, _etask2.default)({ name: 'persist_uuid' }, function* () {
                try {
                    ...
                    _util2.default.perr('unreachable', 'persist_uuid', { err });
                }
            });
        }
                ...
                if (ret) 
                    {
                        ...
                        _util2.default.perr('init_tmp_uuid', { uuid }, { err: true });
                        return this.return(uuid);
                    }
                _uuid = yield get_uuid();
                if (uuid != _uuid)
                _util2.default.perr('uuid_storage_set_err', { uuid, _uuid });
                return uuid;
            });
        }
        ...
        const handle_install = () => (0, _etask2.default)(function* handle_install_() {
            try {
                ...
                _util2.default.perr('switch_uuid_err', { reason });
                ...
                _util2.default.perr('handle_install_err', {}, { err });
            }
        });
        ...
        function ajax_do_op(o) {
            ...
            switch (op) {
                ...
                case 'reload_ext':
                    ...
                    _util2.default.perr('be_reload_ext_ajax_op');
        ...
        E.init = function (opt) {
            ...
            E.sp.spawn((0, _etask2.default)(function* init_() {
                try {
                    ...
                    E.trigger('up');
                    E.set('inited', true);
                } catch (err) {_util2.default.perr('init_err', {}, { err });} finally
                {
                    const get = get_uuid.last_error || [];
                    const set = persist_uuid.last_error || [];
                    if (!get.length && !set.length)
                    return;
                    _util2.default.perr('uuid_storage_err', _zerr2.default.json({ get, set }));
                }
            }));
        ...
        E.uninit = function () {
            if (!E.inited)
            return;
            _util2.default.perr('bg_main_uninit', { stack: new Error('bg_uninit').stack,
                reload_ext: _storage2.default.get_json('reload_ext') });
            _util2.default.perr('bg_main_uninit_log', { stack: new Error('bg_uninit').stack,
                reload_ext: _storage2.default.get_json('reload_ext') }, { with_log: true });
            E.sp.return();
            E.off(); 
            E.stopListening();
        ...
        function inited_cb() {
            ...
            (0, _etask2.default)(function* inited_cb_() {
                ...
                } catch (err) {_util2.default.perr('be_bg_main_init_err', {}, err);}
            });
        }
        ...
        E.set_enabled = on => {
            ...
            return (0, _etask2.default)(function* set_enabled_() {
                try {
                    ...
                    _util2.default.perr('be_bg_main_set_enable_err', {}, { err });
                }
            });
        };
        ...
        const background_init_ajax = () => (0, _etask2.default)(function* _background_init_ajax() {
            ...
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
                ...
                _util2.default.perr('be_background_init_ccgi_failed', { req }, { err: e });}
            req.url = 'https://client.svd-cdn.com/client_cgi/background_init';
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
            catch (e) {
                _util2.default.perr('be_background_init_svd_cdn_failed', { req }, { err: e });}
            req.url = 'https://perr.hola.org/background_init';
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
            catch (e) {
                _util2.default.perr('be_background_init_perr_init_failed', { req }, { err: e });}
            req.method = 'GET';
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
            catch (e) {
                _util2.default.perr('be_background_init_get_ccgi_failed', { req }, { err: e });}
            req.url = 'https://client.svd-cdn.com/client_cgi/background_init';
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
            catch (e) {
                _util2.default.perr('be_background_init_get_svd_cdn_failed', { req }, { err: e });
            }
            req.url = 'https://perr.hola.org/background_init';
            try {return yield _bg_ajax2.default.ccgi_ajax(req);}
            catch (e) {
                _util2.default.perr('be_background_init_get_perr_init_failed', { req },
                { err: e });
            }
        ...
        const background_init = () => (0, _etask2.default)(function* _background_init() {
            ...
            try {
                ...
                _util2.default.perr('be_background_init_ok', { diff, req });
                if (_storage2.default.get('reload_ext_ts'))
                {
                    _util2.default.perr('be_recover_ok', { ts: _storage2.default.get('reload_ext_ts') });
                    _storage2.default.clr('reload_ext_ts');
                }
            } catch (e) {
                _util2.default.perr('be_background_init_err', { req }, { err: e });
                E.set('status', 'error');
                if (_storage2.default.get('reload_ext_ts'))
                {
                    _util2.default.perr('be_recover_failed',
                    { ts: _storage2.default.get('reload_ext_ts') }, { err: e });
                    _storage2.default.clr('reload_ext_ts');
                }
            }
        });
                ...
                switch (data.type) {
                    ...
                    case 'ping':
                        var opt = { val: data.val, url: _conf2.default.url_perr,
                            perr: _util2.default.perr_opt('main_thread_stuck', {},
                            { level: _zerr2.default.L.ERR, rate_limit: { count: 1 } }) };
