// LICENSE_CODE ZON
'use strict'; 
define(['underscore', 'backbone', '/bext/pub/util.js',
    '/bext/vpn/util/util.js', 'zon_config', '/util/etask.js', '/util/util.js'],
    function(_, Backbone, be_util, be_vpn_util, zconf, etask, zutil){
    ...
    safe_set: function(change){
        ...
        _.each(diff, function(val, key){
            try { this.trigger('change:'+key); }
                ...
                be_util.perr('be_safe_set_err', {key, val}, {err,
                    rate_limit: {count: 1}});
        ...
        try { this.trigger('change'); }
            ...
            be_util.perr('be_safe_set_err', {}, {err: e,
                rate_limit: {count: 1}});
