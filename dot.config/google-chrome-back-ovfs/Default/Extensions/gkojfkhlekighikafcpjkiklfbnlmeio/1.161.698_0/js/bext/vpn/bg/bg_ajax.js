// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', 'underscore', '/bext/pub/backbone.js', '/bext/pub/browser.js', '/util/etask.js', '/bext/pub/ext.js', '/util/ajax.js', '/svc/vpn/pub/unblocker_lib.js', '/util/zerr.js', '/util/escape.js', '/util/url.js', '/bext/pub/util.js', '/util/date.js', '/util/version_util.js', '/bext/vpn/util/util.js', '/util/util.js', '/util/storage.js', '/util/rand.js', '/bext/vpn/bg/util.js', 'conf'], function (exports, _underscore, _backbone, _browser, _etask, _ext, _ajax2, _unblocker_lib, _zerr, _escape, _url, _util, _date, _version_util, _util3, _util5, _storage, _rand, _util7, _conf) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _browser2 = _interopRequireDefault(_browser);var _etask2 = _interopRequireDefault(_etask);var _ext2 = _interopRequireDefault(_ext);var _ajax3 = _interopRequireDefault(_ajax2);var _unblocker_lib2 = _interopRequireDefault(_unblocker_lib);var _zerr2 = _interopRequireDefault(_zerr);var _escape2 = _interopRequireDefault(_escape);var _url2 = _interopRequireDefault(_url);var _util2 = _interopRequireDefault(_util);var _date2 = _interopRequireDefault(_date);var _version_util2 = _interopRequireDefault(_version_util);var _util4 = _interopRequireDefault(_util3);var _util6 = _interopRequireDefault(_util5);var _storage2 = _interopRequireDefault(_storage);var _rand2 = _interopRequireDefault(_rand);var _util8 = _interopRequireDefault(_util7);var _conf2 = _interopRequireDefault(_conf);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        BgAjax.prototype.init = function () {
            ...
            var perr = opt => _util2.default.perr(opt.id, opt.info, opt);
            var def = { ignore: [], api: { perr,
