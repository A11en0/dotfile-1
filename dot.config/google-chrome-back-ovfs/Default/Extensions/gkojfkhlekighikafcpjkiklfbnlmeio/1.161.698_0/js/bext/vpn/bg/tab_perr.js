// LICENSE_CODE ZON
;(function () {
    'use strict'; define(['exports', '/bext/pub/backbone.js', '/bext/vpn/bg/tabs.js', '/bext/vpn/util/util.js', '/bext/pub/ext.js', '/bext/pub/util.js', '/svc/vpn/pub/unblocker_lib.js', '/util/zerr.js', '/util/url.js', '/util/util.js'], function (exports, _backbone, _tabs, _util, _ext, _util3, _unblocker_lib, _zerr, _url2, _util5) {Object.defineProperty(exports, "__esModule", { value: true });var _backbone2 = _interopRequireDefault(_backbone);var _tabs2 = _interopRequireDefault(_tabs);var _util2 = _interopRequireDefault(_util);var _ext2 = _interopRequireDefault(_ext);var _util4 = _interopRequireDefault(_util3);var _unblocker_lib2 = _interopRequireDefault(_unblocker_lib);var _zerr2 = _interopRequireDefault(_zerr);var _url3 = _interopRequireDefault(_url2);var _util6 = _interopRequireDefault(_util5);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        const google_captcha_send_perr = _url => {
            ...
            id += '_svc';
            _util4.default.perr(id, { url: _url }, { err: true, rate_limit: { count: 1,
                    disable_drop_count: true } });
        };
        ...
        const on_tab_updated = cb_wrapper(o => {
            const info = o.info;
            if (!_util6.default.get(info, 'url'))
            return;
