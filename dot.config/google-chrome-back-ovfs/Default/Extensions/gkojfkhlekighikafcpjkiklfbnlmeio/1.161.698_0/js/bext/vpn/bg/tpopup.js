    ...
    'use strict';  define(['exports', 'underscore', '/bext/pub/backbone.js', '/util/etask.js', '/bext/pub/util.js', '/bext/vpn/bg/tabs.js', '/bext/pub/ext.js', '/bext/pub/browser.js', '/svc/vpn/pub/util.js', '/bext/vpn/bg/tab_unblocker.js', '/bext/vpn/bg/info.js', '/bext/vpn/bg/rule.js', '/util/zerr.js', '/util/storage.js', '/bext/vpn/bg/iframe.js', '/bext/vpn/bg/premium.js', '/util/util.js', '/bext/vpn/util/util.js', '/util/version_util.js', '/bext/vpn/bg/svc.js', '/bext/vpn/bg/trial.js', '/bext/vpn/bg/util.js', 'zon_config', 'conf'], function (exports, _underscore, _backbone, _etask, _util, _tabs, _ext, _browser, _util3, _tab_unblocker, _info, _rule, _zerr, _storage, _iframe, _premium, _util5, _util7, _version_util, _svc, _trial, _util9, _zon_config, _conf) {Object.defineProperty(exports, "__esModule", { value: true });var _underscore2 = _interopRequireDefault(_underscore);var _backbone2 = _interopRequireDefault(_backbone);var _etask2 = _interopRequireDefault(_etask);var _util2 = _interopRequireDefault(_util);var _tabs2 = _interopRequireDefault(_tabs);var _ext2 = _interopRequireDefault(_ext);var _browser2 = _interopRequireDefault(_browser);var _util4 = _interopRequireDefault(_util3);var _tab_unblocker2 = _interopRequireDefault(_tab_unblocker);var _info2 = _interopRequireDefault(_info);var _rule2 = _interopRequireDefault(_rule);var _zerr2 = _interopRequireDefault(_zerr);var _storage2 = _interopRequireDefault(_storage);var _iframe2 = _interopRequireDefault(_iframe);var _premium2 = _interopRequireDefault(_premium);var _util6 = _interopRequireDefault(_util5);var _util8 = _interopRequireDefault(_util7);var _version_util2 = _interopRequireDefault(_version_util);var _svc2 = _interopRequireDefault(_svc);var _trial2 = _interopRequireDefault(_trial);var _util10 = _interopRequireDefault(_util9);var _zon_config2 = _interopRequireDefault(_zon_config);var _conf2 = _interopRequireDefault(_conf);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
        ...
        E.do_tpopup = (tab, tpopup_opt) => {
            ...
            return loading_tpopups[id] = loading_tpopups[id] || (0, _etask2.default)({ async: true,
                ...
                {
                    _util2.default.perr('be_tpopup_inject', { url: tab_.url,
                ...
                _util2.default.perr('be_tpopup2_err', {}, { err, filehead: ok ?
                    _zerr2.default.log_tail() : '', rate_limit: true });
                delete connected_tpopups[id];
            }]);
        };
        ...
        function send_trial_perr(opt, page, re) {
            ...
            return;
            sent[page] = true;
            _util2.default.perr('be_trial_page', { url: opt.url, root_url: opt.root_url,
                page });
        }
