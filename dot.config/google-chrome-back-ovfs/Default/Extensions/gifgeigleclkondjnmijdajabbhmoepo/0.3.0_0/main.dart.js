...
z=this.cx
if(z!=null)z.V1(0)
for(z=this.a,y=z.gUQ(z),x=y.Q,y=H.J(new H.MH(null,x.gu(x),y.a),[H.S(y,0),H.S(y,1)]);y.D();)y.Q.pr()
if(z.Q>0){z.e=null
z.d=null
z.c=null
z.b=null
...
return["function",v]}return["dart",init.classIdExtractor(a),this.jG(init.classFieldsExtractor(a))]},"$1","gpC",2,0,3,25],
...
self.scheduleImmediate(H.tR(new P.C6(a),0))},"$1","Sx",2,0,33],
...
jZ:{
"^":"r:3;Q,a",
$1:[function(a){P.HZ(this.Q.e,new P.Fe(null,this.a,0,null,null))},null,null,2,0,null,41,"call"]},
FZ:{
"^":"r:7;Q,a",
...
lz:{
"^":"r;Q,a,b,c",
$1:[function(a){P.FE(new P.Rl(this.b,a),new P.Jb(),P.TB(this.Q.a,this.c))},null,null,2,0,null,42,"call"],
...
z.b=!0
z.a=a},null,null,2,0,null,35,"call"],
$signature:function(){return H.IG(function(a){return{func:"Lf",args:[a]}},this.a,"qh")}},
Z5:{
"^":"r:0;Q,a",
$0:[function(){var z,y,x,w
...
z.Gv()}return},
yi:[function(a){this.r.FC(a,this)},"$1","gwU",2,0,function(){return H.IG(function(a,b){return{func:"kA",void:true,args:[a]}},this.$receiver,"fB")},43],
SW:[function(a,b){this.UI(a,b)},"$2","gPr",4,0,44,38,39],
...
T9:[function(a){return J.kI(a)},"$1","rm",2,0,46,47],
...
gvc:function(){return H.J(new P.fG(this),[H.S(this,0)])},
...
gvc:function(){return H.J(new P.i5(this),[H.S(this,0)])},
gUQ:function(a){return H.K1(H.J(new P.i5(this),[H.S(this,0)]),new P.a1(this),H.S(this,0),H.S(this,1))},
NZ:function(a){var z,y
if(typeof a==="string"&&a!=="__proto__"){z=this.a
if(z==null)return!1
...
x=z.$1(C.CD.JV(C.CD.Y(y,60000000),60))
w=z.$1(C.CD.JV(C.CD.Y(y,1000000),60))
v=new P.P7().$1(C.CD.JV(y,1000000))
return H.d(C.CD.Y(y,3600000000))+":"+H.d(x)+":"+H.d(w)+"."+H.d(v)},
...
if(r===10||r===13){q=s
break}++s}p=J.Wx(q)
if(p.T(q,u)>78)if(x-u<75){o=u+75
n=u
m=""
l="..."}else{if(p.T(q,x)<75){n=p.T(q,75)
o=q
l=""}else{n=x-36
o=x+36
l="..."}m="..."}else{o=q
...
return z},
qv:function(a,b,c,d,e,f,g,h,i,j){var z,y,x,w,v
if(i!=null){i=P.Wf(i,i.length)
z=!0}else{i=this.c
z=!1}y=i==="file"
j=this.d
...
aZ:function(a,b,c,d){return this.qv(a,null,b,null,null,c,null,null,d,null)},
Y9:function(a,b,c){return this.qv(a,null,b,null,null,c,null,null,null,null)},
...
u=z.e
if(p<0){o=P.LE(a,J.WB(u,1),w.gv(a),null)
n=null}else{o=P.LE(a,J.WB(u,1),p,null)
n=P.UJ(a,p+1,w.gv(a))}}else{n=u===35?P.UJ(a,J.WB(z.e,1),w.gv(a)):null
o=null}w=z.a
u=z.b
...
z=J.rY(a)
if(z.O2(a,b)===91){y=J.Wx(c)
if(z.O2(a,y.T(c,1))!==93)P.Xz(a,b,"Missing end `]` to match `[` in host")
P.eg(a,J.WB(b,1),y.T(c,1))
return z.Nj(a,b,c).toLowerCase()}if(!d)for(x=b;y=J.Wx(x),y.w(x,c);x=y.g(x,1))if(z.O2(a,x)===58){P.eg(a,b,c)
...
r=(C.aa[r]&C.jn.Ma(1,t&15))!==0}else r=!1
...
y=(C.F3[y]&C.jn.Ma(1,t&15))!==0}else y=!1
...
x=[]
w=b
for(u=b,t=!1;s=J.Wx(u),s.w(u,c);u=J.WB(u,1))if(J.IC(a,u)===58){if(u==null?b==null:u===b){u=s.g(u,1)
...
w=J.WB(u,1)}if(J.wS(x)===0)z.$1("too few parts")
r=J.mG(w,c)
q=J.mG(J.MQ(x),-1)
...
w=J.U(x)
v=w.gv(x)
if(y==null?v==null:y===v){z.f=this.b
return}u=z.e
z.f=w.O2(x,u)
for(t=this.b,s=-1,r=-1;J.UN(z.e,w.gv(x));){q=w.O2(x,z.e)
z.f=q
...
z.f=t}o=z.e
y=J.Wx(r)
if(y.C(r,0)){z.b=P.ua(x,u,r)
n=y.g(r,1)}else n=u
y=J.Wx(s)
if(y.C(s,0)){v=y.g(s,1)
m=z.e
...
if(J.UN(z.e,w.gv(x)))z.f=w.O2(x,z.e)}},
Kd:{
"^":"r:3;",
...
"^":"r:19;Q,a",
$2:function(a,b){var z,y
if(J.aF(b,a)>4)this.a.$2("an IPv6 part can only contain a maximum of 4 hex digits",a)
...
else return P.hE(a,"_$dart_jsObject",new P.Hp($.hs()))}},"$1","En",2,0,3,56],
...
return v}else return P.wY(a)},null,null,2,0,null,56,"call"]},
r7:{
"^":"E4;Q",
...
"^":"",
QL:[function(){var z,y
z=M.T($.P(),J.Q(J.Q($.N(),"chrome"),"storage"))
M.O($.P(),"onInstalled").Z("addListener",[new M.em(z)])
M.O($.W(),"onClicked").Z("addListener",[M.QX()])
M.Z(z)
M.V($.I5(),z)
y=z.a
H.J(new P.X(y),[H.S(y,0)]).yI(new M.Lb(z))},"$0","Da",0,0,1],
...
rp:function(a){M.IO(P.hK(a).Y9(0,"gateway.ipfs.io",80).X(0))},
O:function(a,b){var z,y
z=J.Q(a,b)
if(z instanceof P.E4)y=z
else{if(typeof z==="number"||typeof z==="string"||typeof z==="boolean"||z==null)H.vh(P.p("object cannot be a num, string, bool, or null"))
y=P.ND(P.wY(z))}return y},
Z:function(a){var z,y,x,w
$.yO().nQ("removeAll")
z="http://"+H.d(a.b)+":"+H.d(a.c)
y=[z+"/ipfs/*",z+"/ipns/*"]
x=P.jT(P.B(["contexts",["frame","link","image","video","audio"],"title",J.Q(J.Q($.P().nQ("getManifest"),"page_action"),"default_title"),"documentUrlPatterns",y,"targetUrlPatterns",y,"onclick",new M.CO()],null,null))
z=J.U(x)
w=[]
C.Nm.FV(w,J.C0(z.p(x,"targetUrlPatterns"),P.En()))
z.q(x,"targetUrlPatterns",H.J(new P.Tz(w),[null]))
$.yO().Z("create",[x])},
jD:function(a){var z,y
z=P.jT(P.B(["pageUrl",P.B(["originAndPathMatches",C.xB.g("^http://",a.b)+"(:"+J.Lz(a.c)+")?/(ipfs|ipns)/.+","schemes",["http"]],null,null)],null,null))
y=P.jT([P.B(["conditions",[P.uw(J.Q($.p4(),"PageStateMatcher"),[z])],"actions",[P.uw(J.Q($.p4(),"ShowPageAction"),null)]],null,null)])
M.O($.p4(),"onPageChanged").Z("removeRules",[null,new M.Sq(y)])},
M:[function(a){M.rp(J.Q(a,"url"))},"$1","QX",2,0,58,59],
em:{
"^":"r:3;Q",
$1:[function(a){M.jD(this.Q)},null,null,2,0,null,40,"call"]},
Lb:{
"^":"r:3;Q",
$1:[function(a){var z=this.Q
M.Z(z)
M.jD(z)},null,null,2,0,null,40,"call"]},
CO:{
"^":"r:20;",
$2:[function(a,b){var z,y,x,w
z=["linkUrl","srcUrl","pageUrl","frameUrl"]
y=J.U(a)
x=null
w=0
while(!0){if(!(w<4&&x!==!0))break
if(w>=4)return H.e(z,w)
if(a.Bm(z[w])){M.IO(P.hK(y.p(a,z[w])).Y9(0,"gateway.ipfs.io",80).X(0))
x=!0}++w}},null,null,4,0,null,60,59,"call"]},
Sq:{
"^":"r:0;Q",
$0:[function(){M.O($.p4(),"onPageChanged").Z("addRules",[this.Q])},null,null,0,0,null,"call"]},
Jw:{
"^":"a;Q,a,b,c",
rQ:[function(a,b,c){var z,y
z=J.U(a)
if(z.p(a,"host")!=null){this.b=H.aH(z.p(a,"host"))
J.Q(this.Q,"local").Z("set",[P.jT(P.B(["host",this.b],null,null))])
z=this.a
y=this.b
if(z.b>=4)H.vh(z.Pq())
z.MW(y)}else if(z.p(a,"port")!=null){this.c=H.fJ(z.p(a,"port"))
J.Q(this.Q,"local").Z("set",[P.jT(P.B(["port",this.c],null,null))])
z=this.a
y=this.c
if(z.b>=4)H.vh(z.Pq())
z.MW(y)}else if(z.p(a,"options")!=null&&J.mG(z.p(a,"options"),"hostServer"))c.PO([P.jT(P.B(["host",this.b,"port",this.c],null,null))])},"$3","gtl",6,0,61,62,23,63],
P4:function(a,b){var z=this.gtl()
M.O(a,"onMessage").Z("addListener",[z])
J.Q(this.Q,"local").Z("get",[P.jT(["host","port"]),new M.rs(this)])},
static:{T:function(a,b){var z=H.J(new P.DL(null,null,0,null,null,null,null),[null])
z.d=z
z.c=z
z=new M.Jw(b,z,"localhost",8080)
z.P4(a,b)
return z}}},
rs:{
"^":"r:21;Q",
...
z=J.U(a)
if(z.p(a,"host")!=null){this.Q.b=H.aH(z.p(a,"host"))
y=!0}else y=!1
if(z.p(a,"port")!=null){this.Q.c=H.fJ(z.p(a,"port"))
y=!0}if(y){z=this.Q
x=z.a
z="http://"+H.d(z.b)+":"+H.d(z.c)
if(x.b>=4)H.vh(x.Pq())
x.MW(z)}},null,null,2,0,null,64,"call"]},
lo:{
"^":"a;Q,a,b,c",
TV:[function(a){this.b=!0
this.c=new P.iP(Date.now(),!1)
this.iK()},"$1","ghV",2,0,58,65],
tu:[function(a){var z,y,x
if(this.b&&P.xC(0,0,0,Date.now()-this.c.Q,0,0).Q>30000000){this.b=!1
this.iK()}z=J.U(a)
y=P.hK(z.p(a,"url"))
if(y.c==="file")y=P.hK(P.pE(z.p(a,"url"),C.dy,!1))
if(!this.b){z=this.a
x=y.aZ(0,z.b,z.c,"http")}else x=y.aZ(0,"gateway.ipfs.io",80,"http")
return P.jT(P.B(["redirectUrl",x.X(0)],null,null))},"$1","gkY",2,0,66,43],
Gg:function(){var z,y,x
z=M.O(this.Q,"onErrorOccurred")
y=this.ghV()
x=this.a
x="http://"+H.d(x.b)+":"+H.d(x.c)
z.Z("addListener",[y,P.jT(P.B(["urls",[x+"/ipfs/*",x+"/ipns/*"]],null,null))])},
iK:function(){var z,y,x,w
z=this.Q
M.O(z,"onBeforeRequest").Z("removeListener",[this.gkY()])
z=M.O(z,"onBeforeRequest")
y=this.gkY()
x=["file:///ipfs/*","file:///ipns/*"]
if(this.b){w=this.a
w="http://"+H.d(w.b)+":"+H.d(w.c)
C.Nm.FV(x,[w+"/ipfs/*",w+"/ipns/*"])}else C.Nm.FV(x,["http://gateway.ipfs.io/ipfs/*","http://gateway.ipfs.io/ipns/*"])
z.Z("addListener",[y,P.jT(P.B(["urls",x],null,null)),P.jT(["blocking"])])},
QU:function(a,b){var z
this.Gg()
this.iK()
z=this.a.a
H.J(new P.X(z),[H.S(z,0)]).yI(new M.Qe(this))},
static:{V:function(a,b){var z=new M.lo(a,b,!1,new P.iP(H.fI(H.Nq(0,1,1,0,0,0,0,!1)),!1))
z.QU(a,b)
return z}}},
Qe:{
"^":"r:3;Q",
$1:[function(a){var z=this.Q
M.O(z.Q,"onErrorOccurred").Z("removeListener",[z.ghV()])
z.Gg()
z.b=!1},null,null,2,0,null,40,"call"]}},1],]
...
J.Q=function(a,b){if(a.constructor==Array||typeof a=="string"||H.Xt(a,a[init.dispatchPropertyName]))if(b>>>0===b&&b<a.length)return a[b]
return J.U(a).p(a,b)}
...
I.$lazy($,"_contextMenus","ry","yO",function(){return J.Q(J.Q($.N(),"chrome"),"contextMenus")})
I.$lazy($,"_declarativeContent","jI","p4",function(){return J.Q(J.Q($.N(),"chrome"),"declarativeContent")})
I.$lazy($,"_pageAction","ks","W",function(){return J.Q(J.Q($.N(),"chrome"),"pageAction")})
I.$lazy($,"_runtime","Y","P",function(){return J.Q(J.Q($.N(),"chrome"),"runtime")})
I.$lazy($,"_webRequest","vK","I5",function(){return J.Q(J.Q($.N(),"chrome"),"webRequest")})

init.metadata=[{func:"NT"},{func:"X0",void:true},{func:"Za",args:[P.I,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.I]},{func:"uO",args:[P.I]},{func:"pG",args:[{func:"X0",void:true}]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.Gz]},{func:"bh",args:[null,null]},{func:"DR",ret:P.KN,args:[null,P.KN]},{func:"jt",void:true,args:[P.KN,P.KN]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.I,args:[P.KN]},{func:"N4",ret:P.a2,args:[P.KN]},{func:"Z9",ret:P.KN,args:[null,null]},{func:"xM",void:true,args:[P.I]},{func:"lu",void:true,args:[P.I],opt:[null]},{func:"BC",ret:P.KN,args:[P.KN,P.KN]},{func:"fH",args:[P.E4,P.E4]},{func:"FB",args:[P.E4]},"object","sender","e","x","closure","isolate","numberOfArguments","arg1","arg2","arg3","arg4",{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"LU",void:true,args:[null]},"value",{func:"mQ",void:true,args:[null],opt:[P.Gz]},,"error","stackTrace","_","ignored","element","data",{func:"N5",void:true,args:[null,P.Gz]},{func:"BT",ret:P.a2,args:[null,null]},{func:"xr",ret:P.KN,args:[null]},"a","each",{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},"byteString","callback","captureThis","self","arguments","o",{func:"uJ",ret:P.a,args:[null]},{func:"Hy",void:true,args:[P.E4]},"tab","info",{func:"UY",void:true,args:[P.E4,P.E4,P.r7]},"msg","response","settings","details",{func:"LO",ret:P.E4,args:[P.E4]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(M.Da(),b)},[])}else{(function(b){H.Rq(M.Da(),b)})([])}})
})()
...
Pe.prototype=$desc
Pe.$__fields__=["Q"]
function GS(Q){this.Q=Q}GS.builtin$cls="GS"
...
VX.prototype=$desc
VX.$__fields__=["Q"]
function od(Q){this.Q=Q}od.builtin$cls="od"
...
O6.prototype=$desc
O6.$__fields__=["Q","a"]
function X(Q){this.Q=Q}X.builtin$cls="X"
if(!"name" in X)X.name="X"
$desc=$collectedClasses.X
if($desc instanceof Array)$desc=$desc[1]
X.prototype=$desc
X.$__fields__=["Q"]
...
u8.prototype=$desc
u8.$__fields__=["Q"]
function yU(r){this.r=r}yU.builtin$cls="yU"
...
ez.prototype=$desc
ez.$__fields__=[]
function aA(Q){this.Q=Q}aA.builtin$cls="aA"
...
db.prototype.gcA=function(){return this.a}
db.prototype.scA=function(v){return this.a=v}
db.prototype.gtL=function(){return this.b}
db.prototype.stL=function(v){return this.b=v}
db.prototype.gzQ=function(){return this.c}
db.prototype.szQ=function(v){return this.c=v}
...
tj.prototype.szQ=function(v){return this.b=v}
...
Zi.prototype=$desc
Zi.$__fields__=[]
function u5(Q){this.Q=Q}u5.builtin$cls="u5"
...
Rw.prototype=$desc
Rw.$__fields__=["Q","a","b"]
function GY(Q){this.Q=Q}GY.builtin$cls="GY"
...
wv.prototype=$desc
wv.$__fields__=[]
function iD(Q,a,b,c,d,e,f,r,x){this.Q=Q
this.a=a
this.b=b
this.c=c
this.d=d
...
this.f=f
this.r=r
this.x=x}iD.builtin$cls="iD"
if(!"name" in iD)iD.name="iD"
$desc=$collectedClasses.iD
if($desc instanceof Array)$desc=$desc[1]
iD.prototype=$desc
iD.$__fields__=["Q","a","b","c","d","e","f","r","x"]
...
Kd.prototype=$desc
Kd.$__fields__=[]
function yZ(Q,a){this.Q=Q
this.a=a}yZ.builtin$cls="yZ"
...
Mx.prototype=$desc
Mx.$__fields__=[]
function C9(Q){this.Q=Q}C9.builtin$cls="C9"
if(!"name" in C9)C9.name="C9"
$desc=$collectedClasses.C9
if($desc instanceof Array)$desc=$desc[1]
C9.prototype=$desc
C9.$__fields__=["Q"]
function kZ(Q){this.Q=Q}kZ.builtin$cls="kZ"
if(!"name" in kZ)kZ.name="kZ"
$desc=$collectedClasses.kZ
if($desc instanceof Array)$desc=$desc[1]
kZ.prototype=$desc
kZ.$__fields__=["Q"]
function JT(Q,a){this.Q=Q
this.a=a}JT.builtin$cls="JT"
...
V6.prototype=$desc
V6.$__fields__=[]
function em(Q){this.Q=Q}em.builtin$cls="em"
if(!"name" in em)em.name="em"
$desc=$collectedClasses.em
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
em.$__fields__=["Q"]
function Lb(Q){this.Q=Q}Lb.builtin$cls="Lb"
if(!"name" in Lb)Lb.name="Lb"
$desc=$collectedClasses.Lb
if($desc instanceof Array)$desc=$desc[1]
Lb.prototype=$desc
...
CO.prototype=$desc
CO.$__fields__=[]
function Sq(Q){this.Q=Q}Sq.builtin$cls="Sq"
if(!"name" in Sq)Sq.name="Sq"
$desc=$collectedClasses.Sq
if($desc instanceof Array)$desc=$desc[1]
Sq.prototype=$desc
Sq.$__fields__=["Q"]
function Jw(Q,a,b,c){this.Q=Q
this.a=a
this.b=b
...
if($desc instanceof Array)$desc=$desc[1]
Jw.prototype=$desc
Jw.$__fields__=["Q","a","b","c"]
function rs(Q){this.Q=Q}rs.builtin$cls="rs"
if(!"name" in rs)rs.name="rs"
$desc=$collectedClasses.rs
if($desc instanceof Array)$desc=$desc[1]
rs.prototype=$desc
rs.$__fields__=["Q"]
function lo(Q,a,b,c){this.Q=Q
this.a=a
this.b=b
this.c=c}lo.builtin$cls="lo"
if(!"name" in lo)lo.name="lo"
$desc=$collectedClasses.lo
if($desc instanceof Array)$desc=$desc[1]
lo.prototype=$desc
lo.$__fields__=["Q","a","b","c"]
function Qe(Q){this.Q=Q}Qe.builtin$cls="Qe"
if(!"name" in Qe)Qe.name="Qe"
$desc=$collectedClasses.Qe
if($desc instanceof Array)$desc=$desc[1]
Qe.prototype=$desc
Qe.$__fields__=["Q"]
return[FK,Gv,yE,PE,Ue,iC,kd,G,F,im,VA,E,PK,JO,O2,aX,NY,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,yH,FA,Av,ku,jP,fP,LI,FD,Cj,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,r,Bp,q,Pe,GS,lb,tD,hJ,dC,wN,VX,od,aL,a7,i1,xy,MH,A8,SU,Ja,XC,GD,th,ha,C6,Ft,O6,X,JI,WV,DL,b8,Fe,vs,da,pV,U7,rH,eX,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,VV,Dy,UH,Z5,MO,u8,yU,NO,KA,Vo,qB,ez,aA,LV,DS,yR,B3,CR,Qk,EM,v1,uR,YR,fB,t3,OH,m0,pK,R8,hj,MK,k6,PL,fG,EQ,YB,a1,ey,db,i5,N6,b6,tj,zQ,u3,mW,LU,E9,lD,LG,Sw,o0,Ma,Vj,Uk,zF,Zi,u5,E3,Rw,GY,bz,b2,yn,CL,a2,iP,CP,a6,P7,DW,Ge,LK,AT,bJ,eY,JS,ub,ds,lj,UV,k5,VS,t7,HG,aE,kM,KN,An,zM,c8,lf,a,Gz,I,Rn,wv,iD,hP,uH,Kd,yZ,G1,Mx,C9,kZ,JT,rI,qE,Gh,fY,Az,QP,IF,nx,d7,bA,Nh,IB,cv,hY,ea,D0,Yu,Sg,Mi,wP,El,Qb,bn,Ik,oU,KV,BH,nN,ec,Ql,wL,HD,KR,lp,zD,FB,K5,YC,hq,w4,Nf,Gm,W9,hF,Y0,hf,ui,jw,lv,pf,py,W1,ee,wf,bb,tk,me,oB,yu,MI,bM,Qy,ju,OE,zU,rE,uz,NB,Gr,qI,d5,hy,aS,qF,Rk,Eo,ci,ZD,cu,zI,cB,Pi,zu,IU,E4,Gn,r7,Tz,Wk,DV,Hp,Nz,Jd,QS,WZ,ET,T1,b0,Dg,Ob,GV,Pg,fj,Ip,Hg,K8,xj,dE,ZA,dT,Pq,eE,V6,em,Lb,CO,Sq,Jw,rs,lo,Qe]}